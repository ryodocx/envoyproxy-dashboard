...
func (rgb *RouteGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RouteGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RouteGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *RouteGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RouteGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RouteGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *RouteGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RouteGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RouteGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (rgb *RouteGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(rgb.fields) > 1 {
		return nil, errors.New("db: RouteGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := rgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rgb *RouteGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RouteSelect) Strings(ctx context.Context) ([]string, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RouteSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RouteSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RouteSelect) Ints(ctx context.Context) ([]int, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RouteSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RouteSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RouteSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RouteSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RouteSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (rs *RouteSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(rs.fields) > 1 {
		return nil, errors.New("db: RouteSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := rs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (rs *RouteSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{route.Label}
	default:
		err = fmt.Errorf("db: RouteSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
